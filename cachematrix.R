...
cacheSolve <- function(x, ...) {  # CacheSolve "detects" that the inverse has been "cleared" (when the set function in makeCacheMatrix function changed the matrix), so the 'return' is not executed...
        ...
        if(!is.null(i)) {
                ...
                return(i)
                                ...
                                # ...rather the function continutes by getting the new matrix, calculating the inverse and then setting (caching) it:
